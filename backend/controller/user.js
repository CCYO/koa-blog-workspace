...
async function _findInfoForUserPage(user_id) {
  ...
  let data = {
    ...
    blogs: {
      [CONSTANT.BLOG.STATUS.PUBLIC]:
        public_resModel.data[CONSTANT.BLOG.STATUS.PUBLIC],
      [CONSTANT.BLOG.STATUS.PRIVATE]:
        private_resModel.data[CONSTANT.BLOG.STATUS.PRIVATE],
      [CONSTANT.BLOG.STATUS.PAGINATION]: PAGINATION.BLOG,
    },
  };
  return new SuccModel({ data });
}
