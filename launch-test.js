...
const PORT = {
  ...
  DEBUG_WEBPACK_BUILD_FRONTEND:
    process.env.DEBUG_WEBPACK_BUILD_FRONTEND || 9222,
...
const frontend = () => {
  go({
    ...
    debugPort: PORT.DEBUG_WEBPACK_BUILD_FRONTEND, // Webpack DevServer 偵錯埠
  });
};
